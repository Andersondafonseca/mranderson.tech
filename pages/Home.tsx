          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left">
              ...
              <p className="mt-6 text-lg md:text-xl text-slate-300 max-w-2xl mx-auto md:mx-0">
                Conecto ideias, pessoas e tecnologia para construir o futuro. Explore meu trabalho e vamos criar algo extraordinário juntos.
              </p>
            ...
            <div className="flex items-center justify-center">
                <img
                    src="https://as7portas1.websiteseguro.com/mranderson2.png"
                    alt="Mr. Anderson"
                    className="w-full max-w-md md:max-w-full h-auto"
                    // Fix: Changed `fetchpriority` to `fetchPriority` to match React's camelCase prop convention.
                    fetchPriority="high"
                    decoding="async"
                />
            </div>
